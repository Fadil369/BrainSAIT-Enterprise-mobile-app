...
impl Base {
    ...
    pub fn serializeCKCData(serverCtx: &mut FPSServerCtx) -> Result<()> {
        // Populate common TLLVs
        Base::populateTagCK(serverCtx.ckcContainer.ckcData.contentKeyTLLVTag, serverCtx)?;
        ...
        Extension::HDCPInformationTagPopulateCustom(serverCtx)?;
        Extension::securityLevelTagPopulateCustom(serverCtx)?;
        Extension::serializeCKCDataCustom(serverCtx)?;
